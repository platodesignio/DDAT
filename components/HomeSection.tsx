    ...
    <div className="max-w-3xl">
      ...
      <div className="border border-gray-200 divide-y divide-gray-100">
        {[
          ...
          { n: "5",  field: "Nine Generative-Rate Evaluations",  detail: "Evaluations (0–5) for each rate with the evaluator's textual justification." },
          { n: "6",  field: "Penalty Factors",                   detail: "Active risk flags, their definitions, and weighted penalty values." },
          { n: "7",  field: "Directional Correctness Index (DCR) — Baseline",   detail: "Raw DCR, total penalty, and final DCR with directional classification before any intervention." },
          { n: "8",  field: "Primary Future-Closure Mechanisms", detail: "Enumeration of the structural factors most responsible for a low DCR." },
          { n: "9",  field: "Recommended Institutional Changes",  detail: "Ordered list of design interventions with projected DCR impact for each." },
          { n: "10", field: "Directional Correctness Index (DCR) — Post-Intervention", detail: "Simulated DCR with rate-level changes and remaining risks documented." },
