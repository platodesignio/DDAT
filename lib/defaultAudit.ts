import type { AuditTarget, GenerativeRates, RiskFlags } from "@/types"

export const DEFAULT_TARGET: AuditTarget = {
  title: "AI Hiring Score Audit",
  domain: "labor",
  description:
  ...
  evaluator: "Hiring platform vendor / HR department",
...
export const DEFAULT_RATES: GenerativeRates = {
  IGR: 2,
  PDFR: 1,
  MGR: 2,
  DRGR: 1.5,
...
export const DEFAULT_FLAGS: RiskFlags = {
